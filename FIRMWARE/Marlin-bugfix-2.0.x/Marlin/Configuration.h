...
#define STRING_CONFIG_H_AUTHOR "(zJHolez, BlueR Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "I was born"
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE           { 250, 250, 55, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 18, 28.5, -3.5 }
...
#define XY_PROBE_FEEDRATE (153*60)

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (6*60)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 1.25)
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_USE_PROBE
    ...
    #define LEVEL_CORNERS_PROBE_TOLERANCE 0.08
